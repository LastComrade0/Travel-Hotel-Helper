...
public class DeleteReviewServlet extends HttpServlet {
    ...
    public DeleteReviewServlet(HotelCollection hotelCollection, ReviewCollectionsThreadSafe reviewCollectionsThreadSafe) {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException{
        ...
        HotelReview hotelReview = databaseHandler.getSingleReview(reviewID);
        ...
        System.out.println("Delete review " + hotelReview.getReviewID()
                + " as: " + username + "?");

        out = response.getWriter();

        VelocityEngine ve = (VelocityEngine) session.getServletContext().getAttribute("templateEngine");
        Template template = ve.getTemplate("templates/deleteReviewTemplate.html");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if(request.getParameter("delete") != null) {
            DatabaseHandler databaseHandler = DatabaseHandler.getInstance();
            databaseHandler.deleteReview(reviewID);
        }
